...
export default function CalculatorsPage() {
  const intro = [
    "계산기 목록에서는 제도별로 필요한 조건을 따로 확인할 수 있습니다. 통합 검색으로 전체 후보를 살펴본 뒤, 근로장려금은 가구 유형과 연소득, 실업급여는 고용보험과 퇴사 사유, 청년 월세 지원은 나이와 주거 조건처럼 각 제도에서 중요한 항목을 다시 점검하는 흐름에 맞췄습니다.",
    "각 계산기 상세 페이지에는 공식 신청처, 공식 출처, 내부 상세 안내 링크를 함께 배치했습니다. 계산 결과는 입력값 기반의 참고용 가능성 안내이며, 실제 지급 여부와 금액은 담당 기관의 최신 공고, 제출 서류, 심사 결과에 따라 달라집니다."
  ];
  return (
