...
export default function BenefitsPage() {
  const intro = [
    "정부지원금 전체 목록은 계산기 유무와 관계없이 사이트에서 안내하는 주요 제도를 한 화면에서 비교하는 허브입니다. 청년, 주거, 출산·육아, 고용·실업, 노인, 저소득·세제지원처럼 생활 상황별로 나누어 대상자, 신청기관, 지원 금액, 신청 시기를 빠르게 확인할 수 있습니다.",
    "지원금 이름이 비슷해도 담당 기관과 신청 기준은 다를 수 있습니다. 예를 들어 국세청 장려금은 가구 유형과 연간 총소득을 보고, 고용보험 급여는 고용보험 이력과 휴직 또는 실직 상태를 봅니다. 각 상세 페이지의 기준 확인일과 공식 출처를 신청 전에 다시 확인하세요."
  ];
  return (
