...
export default function CategoryPage() {
  const items = benefits.filter((benefit) => benefit.category === "youth");
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
      <p className="text-sm font-bold text-brand-600">{categoryLabels["youth" as keyof typeof categoryLabels]}</p>
      <h1 className="mt-3 text-4xl font-black text-slate-950">청년 지원금</h1>
      <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">청년 자산형성, 월세, 취업 관련 지원금을 확인하세요.</p>
