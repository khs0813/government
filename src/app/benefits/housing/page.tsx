...
export default function CategoryPage() {
  const items = benefits.filter((benefit) => benefit.category === "housing");
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
      <p className="text-sm font-bold text-brand-600">{categoryLabels["housing" as keyof typeof categoryLabels]}</p>
      <h1 className="mt-3 text-4xl font-black text-slate-950">주거 지원금</h1>
      <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">월세, 전세, 신혼부부 주거 관련 지원금을 확인하세요.</p>
